...
<div class="quiz__themes">
    ...
    <button onclick="startFunAnimalsFacts()" id="6" class="quiz__themes-button">
    ...
    <button onclick="startFunAnimalsFacts()" id="7" class="quiz__themes-button">
    ...
    <button onclick="startFunAnimalsFacts()" id="8" class="quiz__themes-button">
    ...
    <button onclick="startFunAnimalsFacts()" id="9" class="quiz__themes-button">
